...
(function(dice) {
	...
	this.create_dice_materials = function(face_labels, size, margin) {
		...
		var materials = [];
		for (var i = 0; i < face_labels.length; ++i) materials.push(new THREE.MeshPhongMaterial($t.copyto(this.material_options, {
	...
	this.create_d4_materials = function(size, margin, labels) {
		...
		var materials = [];
		for (var i = 0; i < labels.length; ++i) materials.push(new THREE.MeshPhongMaterial($t.copyto(this.material_options, {
