...
function updatePos(t, e) {
	...
	function x(t, e, n, i, o) {
		...
		for (p.textContent = "", f = 0; r = h[f++];)
			...
			else if (l = gt.contains(r.ownerDocument, r), s = y(p.appendChild(r), "script"), l && b(s), n)
	...
	var vt = function(t) {
		...
		function m(t, e, n, o, r, s) {
			return o && !o[F] && (o = m(o)), r && !r[F] && (r = m(r, s)), i(function(i, s, a, u) {
				var l, c, p, h = [],
					...
					b = n ? r || (i ? t : m || o) ? [] : s : y;
				if (n && n(y, b, a, u), o)
					for (l = g(b, f), o(l, [], a, u), c = l.length; c--;)(p = l[c]) && (b[f[c]] = !(y[f[c]] = p));
				if (i) {
					if (r || t) {
						if (r) {
		...
		var b, x, T, w, C, S, E, A, k, D, N, M, j, L, $, R, P, q, I, F = "sizzle" + 1 * new Date,
			O = t.document,
			H = 0,
			_ = 0,
			W = n(),
					...
					return 1 === i && 0 === o ? function(t) {
						...
						if (m) {
							...
							if (d = [s ? m.firstChild : m.lastChild], s && y) {
								for (h = m, p = h[F] || (h[F] = {}), c = p[h.uniqueID] || (p[h.uniqueID] = {}), l = c[t] || [], f = l[0] === H && l[1], b = f && l[2], h = f && m.childNodes[f]; h = ++f && h && h[g] || (b = f = 0) || d.pop();)
									if (1 === h.nodeType && ++b && h === e) {
										c[t] = [H, f, b];
										break
									}
							} else if (y && (h = e, p = h[F] || (h[F] = {}), c = p[h.uniqueID] || (p[h.uniqueID] = {}), l = c[t] || [], f = l[0] === H && l[1], b = f), !1 === b)
								for (;
									(h = ++f && h && h[g] || (b = f = 0) || d.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++b || (y && (p = h[F] || (h[F] = {}), c = p[h.uniqueID] || (p[h.uniqueID] = {}), c[t] = [H, b]), h !== e)););
	...
	gt.ajaxSetup({
		...
		var o, r, s, a = !1 !== e.jsonp && (Pe.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Pe.test(e.data) && "data");
...
function(t, e) {
	...
	function(t, e) {
		...
		var v = function(o) {
			if (o = o || {}, void 0 !== o.seed && null !== o.seed && o.seed === parseInt(o.seed, 10)) g = o.seed;
			else if ("string" == typeof o.seed) g = d(o.seed);
			else {
